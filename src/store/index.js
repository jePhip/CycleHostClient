...
export const useRouteStore = defineStore("routeStore", {
  ...
  actions: {
    ...
    async updateRoute(updatedRoute) {
      ...
      let response = await fetch(`https://cyclebackend1-pu2nnnh6.b4a.run/v1/geo/${id}`, {
        method: "PUT",
      });
    ...
    async addRoute(routeToAdd) {
      ...
      let response = await fetch(`https://cyclebackend1-pu2nnnh6.b4a.run/v1/geo/`, {
        method: "POST",
        headers: {
    ...
    async getRoutesInit() {
      //tested
      try {
        let response = await fetch("https://cyclebackend1-pu2nnnh6.b4a.run/v1/geo"); //eventually change to env variable
        response = await response.json();
